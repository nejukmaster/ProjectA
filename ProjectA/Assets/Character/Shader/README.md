...
=====================
#### Character Shader is based on unity-chan. And this is written with hlsl as this project runs on URP. The Iilustrative NPR shader is implemented by following five processes.
...
Body Shader does not necessarily have to show as smoothly as Skin Shader so Normal dot Light value is used only. And the clothes should show wrinkles, So, I apply normal mapping to shader. 
