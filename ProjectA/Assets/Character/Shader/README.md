...
=====================
#### Character Shader is based on unity-chan, and written with hlsl because this project runs on URP. The Iilustrative NRP shader is implemented in the following five processes
